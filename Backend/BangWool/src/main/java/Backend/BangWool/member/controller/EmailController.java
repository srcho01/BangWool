...
import Backend.BangWool.member.dto.EmailCheckRequestDto;
import Backend.BangWool.member.dto.EmailSendRequestDto;
...
public class EmailController {
    ...
    @PostMapping("send")
    public StatusResponse mailSend(@Valid @RequestBody EmailSendRequestDto sendDto) {
    ...
    @PostMapping("check")
    public DataResponse<Boolean> mailCheck(@Valid @RequestBody EmailCheckRequestDto checkDto) {
